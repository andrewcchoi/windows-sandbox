#!/bin/bash
# ============================================================================
# CLAUDE CODE SANDBOX - Network Firewall Configuration Script
# ============================================================================
# This script configures iptables to restrict outbound network access from
# the DevContainer. It supports two modes:
#
# - STRICT MODE (default): Whitelist approach - only allow specified domains
...
# CUSTOMIZE: Set to "strict" or "permissive"
...
echo ""
echo "To switch to permissive mode:"
echo "1. Set FIREWALL_MODE=permissive in devcontainer.json"
