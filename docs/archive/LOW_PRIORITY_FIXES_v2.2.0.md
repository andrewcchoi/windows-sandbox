...
**Issue:** Repository called both "sandbox-maxxing" (GitHub) and "sandbox" (docs)
...
- Added clarification to README.md header:
  ...
  ```
- Official name: "sandbox-maxxing" (GitHub URL)
...
**Current Text:**
```markdown
This example shows what the `sandbox-maxxing` plugin generates when run in Basic mode
```

**Analysis:**
- Uses "sandbox-maxxing" (which is correct)
