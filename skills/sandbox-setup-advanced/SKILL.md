...
ls -la "$PLUGIN_ROOT/templates/output-structures/advanced/"
```
...
cp "$PLUGIN_ROOT/templates/output-structures/advanced/docker-compose.yml" ./docker-compose.yml
cp "$PLUGIN_ROOT/templates/output-structures/advanced/.devcontainer/"* ./.devcontainer/
